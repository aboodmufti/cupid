...
void StudentProfilePage::setStudentProfile(StudentProfile* stuProfile){
    ...
    if(studentProfile->getName() != "unknown"){
        ...
        ui->ownQList->insertItem(1,(*(studentProfile->getOwnQ()))[1]); //convert to actual answer: from int to meaningful string

        ui->ownQList->insertItem(2,"Qualification question....");
        ui->ownQList->insertItem(3,(*(studentProfile->getOwnQ()))[2]);

        ui->ownQList->insertItem(4,"Qualification question....");
        ui->ownQList->insertItem(5,(*(studentProfile->getOwnQ()))[3]);

        ui->ownQList->insertItem(6,"Qualification question....");
        ui->ownQList->insertItem(7,(*(studentProfile->getOwnQ()))[4]);

        ui->ownQList->insertItem(8,"Qualification question....");
        ui->ownQList->insertItem(9,(*(studentProfile->getOwnQ()))[5]);

        ui->ownQList->insertItem(10,"Qualification question....");
        ui->ownQList->insertItem(11,(*(studentProfile->getOwnQ()))[6]);

        ui->ownQList->insertItem(12,"Qualification question....");
        ui->ownQList->insertItem(13,(*(studentProfile->getOwnQ()))[7]);

        ui->ownQList->insertItem(14,"Qualification question....");
        ui->ownQList->insertItem(15,(*(studentProfile->getOwnQ()))[8]);

        ui->ownQList->insertItem(16,"Qualification question....");
        ui->ownQList->insertItem(17,(*(studentProfile->getOwnQ()))[9]);

        ui->ownQList->insertItem(18,"Qualification question....");
        ui->ownQList->insertItem(19,(*(studentProfile->getOwnQ()))[10]);

        ui->ownQList->insertItem(20,"Qualification question....");
        ui->ownQList->insertItem(21,(*(studentProfile->getOwnQ()))[11]);

        ui->ownQList->insertItem(22,"Qualification question....");
        ui->ownQList->insertItem(23,(*(studentProfile->getOwnQ()))[12]);

        ui->ownQList->insertItem(24,"Qualification question....");
        ui->ownQList->insertItem(25,(*(studentProfile->getOwnQ()))[13]);



        ui->partnerQList->insertItem(0,"Qualification question....");
        ui->partnerQList->insertItem(1,(*(studentProfile->getPartnerQ()))[1]); //convert to actual answer: from int to meaningful string

        ui->partnerQList->insertItem(2,"Qualification question....");
        ui->partnerQList->insertItem(3,(*(studentProfile->getPartnerQ()))[2]);

        ui->partnerQList->insertItem(4,"Qualification question....");
        ui->partnerQList->insertItem(5,(*(studentProfile->getPartnerQ()))[3]);

        ui->partnerQList->insertItem(6,"Qualification question....");
        ui->partnerQList->insertItem(7,(*(studentProfile->getPartnerQ()))[4]);

        ui->partnerQList->insertItem(8,"Qualification question....");
        ui->partnerQList->insertItem(9,(*(studentProfile->getPartnerQ()))[5]);

        ui->partnerQList->insertItem(10,"Qualification question....");
        ui->partnerQList->insertItem(11,(*(studentProfile->getPartnerQ()))[6]);

        ui->partnerQList->insertItem(12,"Qualification question....");
        ui->partnerQList->insertItem(13,(*(studentProfile->getPartnerQ()))[7]);

        ui->partnerQList->insertItem(14,"Qualification question....");
        ui->partnerQList->insertItem(15,(*(studentProfile->getPartnerQ()))[8]);

        ui->partnerQList->insertItem(16,"Qualification question....");
        ui->partnerQList->insertItem(17,(*(studentProfile->getPartnerQ()))[9]);

        ui->partnerQList->insertItem(18,"Qualification question....");
        ui->partnerQList->insertItem(19,(*(studentProfile->getPartnerQ()))[10]);

        ui->partnerQList->insertItem(20,"Qualification question....");
        ui->partnerQList->insertItem(21,(*(studentProfile->getPartnerQ()))[11]);

        ui->partnerQList->insertItem(22,"Qualification question....");
        ui->partnerQList->insertItem(23,(*(studentProfile->getPartnerQ()))[12]);

        ui->partnerQList->insertItem(24,"Qualification question....");
        ui->partnerQList->insertItem(25,(*(studentProfile->getPartnerQ()))[13]);
        */
    }
    else{
