Authors: 
       Name:Hussam Abu Baker   Name:Abdulrahman Mufti   Name: Dania Ghazal   Name: Zeinab Abu Sharkh
       ID: 100828978	       ID: 100884076		ID: 100955248        ID: 100953183
...
1) The "Final" folder (which includes all subsystems with the source code and database).
...
1) Click on the "Final.pro" file located in "Final" folder.

2) Qt creator will launch, click on the green "play" button located at the lower
   left corner of Qt creatoror or press "ctrl+R".
...
To run the algorithm please do the following:

1) First, login as an administrator (please look at the list of administrators below).

2) Click on a project of your choice.

3) Click on the "Run Algorithm" button.

-------------------------------------------------------------------------------------------------------

Below is a list of administrators and students that already exist in the database once
...
Miscellaneous notes for the TA:

1) In the project page: an administrator can view a student’s profile page by clicking on the student from the list of students in the project.
...
3) Unpublished projects are not visible to students. The administrator must publish these projects for the students to be able to join them if they wish.
