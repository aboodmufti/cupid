...
1) Click on the "cupid_UI.pro" shorcut file located in cuPID folder.
   (Note: if the shortcut doesn't work, please navigate to the folder named
   "all_Combined" and look for "cupid_newUI.pro" file and click it).

2) Qt creator will launch, click on the green "play" button located at the lower
   left corner of Qt creatoror press "ctrl+R".
